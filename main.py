...
while True:
    ...
    if choice == '1':
        ...
        while True:
            ...
            print("1. Список всех аудиозаписей, отсортированный по следующему"
                  " ключу: исполнитель (по возрастанию) + год выпуска"
                  " (по убыванию) + количество прослушиваний (поубыванию).")
