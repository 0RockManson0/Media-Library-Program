...
try:
    while True:
        ...
        if choice == '1':
            ...
            while True:
                ...
                print("1. Список всех аудиозаписей, отсортированный"
                      " по следующему"
                      " ключу: исполнитель (по возрастанию) + год выпуска"
                      " (по убыванию) + количество прослушиваний"
                      " (поубыванию).")
                print("2. Список всех аудиозаписей конкретного"
                      " исполнителя,"
                      " отсортированный по следующему ключу: альбом"
                      " (по убыванию)"
    ...
    print("Перезапустите код чтобы увидеть изменения")
